...
import CV from "../../assets/hamad_CV_WD.pdf";

const Data = () => {
  return (
    <div className="space-y-6">
      <h1 className="text-4xl md:text-5xl font-bold text-[#333333] flex items-center">
        Hamad Ismail
        <svg
          width="36"
          height="36"
      ...
      <h3 className="text-xl font-normal relative pl-14 text-gray-600 before:absolute before:w-12 before:h-[2px] before:bg-gray-500 before:top-3 before:left-0">
        MERN Stack Developer
      </h3>

      <p className="max-w-md text-gray-600">
        MERN-stack developer dedicated to design and creative solutions.
      </p>

      <a
        download=""
        href={CV}
        className="inline-flex items-center gap-2 px-6 py-3 bg-[#333333] hover:bg-[#9fbc49] text-white font-medium rounded-md transition"
      >
        Download CV
        <svg
          class="button__icon"
